...
public class DBConstants {
	...
	public static final String SAVE_TICKET = "insert into ticket(PARKING_NUMBER, VEHICLE_REG_NUMBER, PRICE, IN_TIME, OUT_TIME) SELECT ?,?,?,?,? WHERE NOT EXISTS( SELECT * FROM ticket where VEHICLE_REG_NUMBER = ? and OUT_TIME is null)";
